...
@Controller
public class UserManagment_201_controller {
    ...
    @CrossOrigin
    @PostMapping("201/UserManagmentAdd")
    @ResponseBody
...
//            System.out.println(user1);
    ...
    @CrossOrigin
    @PostMapping("201/UserManagmentDelete")
    @ResponseBody
    ...
    @CrossOrigin
    @PostMapping("201/UserManagmentUpdate")
    @ResponseBody
...
//                Integer id=userlist.get(1).getId();
    ...
    @CrossOrigin
    @PostMapping("201/UserManagmentSelect")
    @ResponseBody
