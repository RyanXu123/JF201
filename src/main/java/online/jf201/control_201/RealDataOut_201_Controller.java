...
@Controller
public class RealDataOut_201_Controller {
    @Autowired
    private JdbcTemplate jdbc;


    @CrossOrigin
    @PostMapping("/getData/201/realdata/out")
    @ResponseBody
    public List<Map<String,Object>> dataout(@RequestBody List<String> data) {
        //        kt2
        List<Map<String, Object>> list_all = new ArrayList<>();
        String sql_data = "  select * from realdata_once where Location='JF201' and Equipment='空调1' and PointName='送风温度1' ";//从表中筛选某空调的所有参数
