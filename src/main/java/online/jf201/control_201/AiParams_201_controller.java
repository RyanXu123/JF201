...
@Controller
public class AiParams_201_controller {
...
//    String ai_time="30min";
    ...
    @CrossOrigin
    @RequestMapping("/getData/201/aiparams")
    @ResponseBody
...
//        temp1.put("冷通道分段阈值",cold_rang);
    ...
    @CrossOrigin
    @PostMapping("/getData/201/aiparams")
    @ResponseBody
//    @Scheduled(fixedRate = 30000)
    ...
    private void checkAndUpdate(String key, String currentValue, String newValue, String userName, String userRole, String timeOperate) {
        if (!newValue.equals(currentValue)) {
            ...
            // 写入数据库
            String sql_insert = "INSERT INTO log(content, userName, userRole, time, datacenter_room) VALUES('" + key + newValue + "','" + userName + "','" + userRole + "','" + timeOperate + "','JF201');";
...
//    private String userRole = "admin";   //默认用户权限
    ...
    @CrossOrigin
    @RequestMapping("/getData/201/aicontrol")
    @ResponseBody
//    @Scheduled(fixedRate = 30000)
    ...
    @CrossOrigin
    @PostMapping("/getData/201/aicontrol")
    @ResponseBody
//    @Scheduled(fixedRate = 30000)
    public List<String> aicontrol2(@RequestBody List<String> data) {
        ...
        if (restartTemp.equals("1")) {
            ...
            if (!restartTemp.equals(restart)){
                String sql_insert1 = "insert into log(content, userName, userRole, time, datacenter_room) values('" + rebootlog + "','" + userName + "','" + userRole + "','" + time_operate + "','JF201');";
        ...
        if (openAiTemp.equals("1")) {
            ...
            if (!openAiTemp.equals(openAi)){
                String sql_insert = "insert into log(content, userName, userRole, time, datacenter_room) values('" + aiopenlog + "','" + userName + "','" + userRole + "','" + time_operate + "','JF201');";
                jdbc.execute(sql_insert);
            }
